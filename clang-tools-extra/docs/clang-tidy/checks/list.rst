...
.. csv-table::
   ...
   `bugprone-implicit-widening-of-multiplication-result <bugprone-implicit-widening-of-multiplication-result.html>`_,
   ...
   `cppcoreguidelines-virtual-class-destructor <cppcoreguidelines-virtual-class-destructor.html>`_,
   ...
   `misc-add-getter <misc-add-getter.html>`_,
